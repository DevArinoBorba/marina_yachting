# Marina Yachting — Landing Page B2B (Gênova 1878)

Landing Page Institucional desenvolvida para franquia e representação B2B da marca italiana **Marina Yachting (Since 1878)**, direcionada a proprietários de alfaiatarias, ateliês de alta costura, empresários e lojistas premium.
...
- **Mostruário Interativo**: Catálogo de blazers em Lã Fria 110's, aviamentos em latão naval e etiquetas em jacquard, com modal de ficha técnica e consulta direta de lote via WhatsApp.
